...
export const TestUiDeclarations = [LayoutComponent, HeaderComponent];
...
export const TestDashboardDeclarations = [DashboardComponent];

export const TestLoginDeclarations = [LoginComponent, LogoutComponent];
...
export const TestAllDeclarations = [AppComponent, ...TestCommonDeclarations];

export const TestFormImports = [ReactiveFormsModule, FormsModule];
...
export const TestCommonImports = [...TestFormImports, ...TestRoutingImports];

export const TestAuthServices = [HttpClient, AuthService];
