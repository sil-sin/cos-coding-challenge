...
describe("AuthService", () => {
  ...
  describe("login()", () => {
    it("login() should return user login data", () => {
      service.login(loginData).then((status) => {
    ...
    it("validateTokenOnServer() should return user data from server", () => {
      service.login(loginData).then((status) => {
        service.validateTokenOnServer().subscribe((statusToken) => {
  ...
  describe("logout()", () => {
    ...
    it("should clear token after logout", () => {
      service.login(loginData).then((loginStatus) => {
        service.logout().then((logoutStatus) => {
